...
map.getView().fit([-13269372.476708, 3987715.193180, -13000671.514339, 4134129.698834], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">2026A Online Auction (April 18 - 21, 2026)</h2>';
        return titleElement;
    })(),
