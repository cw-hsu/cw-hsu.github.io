...
map.getView().fit([-13213902.283940, 4012417.551674, -13113425.994578, 4067036.625880], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">LA Bikeways and Parks</h2>';
        return titleElement;
    })(),
